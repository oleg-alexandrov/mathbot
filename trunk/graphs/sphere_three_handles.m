   ...
   Shift = 7; % shift torus away from origin
   ...
   theta = pi/2.6; % angle between handles, measured from sphere center
   W = zeros(N, N, N) + 100;
...
%   saveas(gcf, 'Sphere_with_three_handles.eps', 'psc2');
   print('-dpng',  '-zbuffer',  '-r400', sprintf('Sphere_with_three_handles%d.png', N));
   %print('-dpng', '-r100', 'Sphere_with_three_handles.png');
